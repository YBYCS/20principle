...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SwitchControl_t, stringdata0) + ofs), len 
...
const QMetaObject SwitchControl::staticMetaObject = { {
    ...
    qt_meta_stringdata_SwitchControl.offsetsAndSize,
    qt_meta_data_SwitchControl,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SwitchControl_t
, QtPrivate::TypeAndForceComplete<SwitchControl, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<bool, std::false_type>
